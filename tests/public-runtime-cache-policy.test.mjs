...
test("all iframe entry points share runtime v54 for this rollout", () => {
  assert.match(rootPage, /\/project\/index\.html\?v=54/);
  assert.match(previewPage, /preview=1&v=54/);
  assert.match(sharedPage, /projectSlug=.*&v=54/);
});
