...
test("all iframe entry points share runtime v57 for this rollout", () => {
  assert.match(rootPage, /\/project\/index\.html\?v=57/);
  assert.match(previewPage, /preview=1&v=57/);
  assert.match(sharedPage, /projectSlug=.*&v=57/);
});
