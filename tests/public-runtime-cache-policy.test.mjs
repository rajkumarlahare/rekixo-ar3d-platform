...
test("all iframe entry points share runtime v56 for this rollout", () => {
  assert.match(rootPage, /\/project\/index\.html\?v=56/);
  assert.match(previewPage, /preview=1&v=56/);
  assert.match(sharedPage, /projectSlug=.*&v=56/);
});
