...
test("all iframe entry points share runtime v60 for this rollout", () => {
  assert.match(rootPage, /\/project\/index\.html\?v=60/);
  assert.match(previewPage, /preview=1&v=60/);
  assert.match(sharedPage, /projectSlug=.*&v=60/);
});
